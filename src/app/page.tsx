...
export default function Home() {
  const [splatRadius, setSplatRadius] = useState(0.2);
      ...
      >
        ...
        >
          <a
            ...
            target="_blank"
          >
            Creator <small>{"//"}</small> Engineer <small>{"//"}</small> Leader
          </a>
          <GooeyText
            id="tagline-morphs"
            onInitialRender={() => {
        ...
        <div className="center phrase">
          <h4>Your Secret Phrase is:</h4>
        </div>

        <div className="center phrase">
          <h3>
            HACK THE PLANET<big>!</big>
          </h3>
        </div>
